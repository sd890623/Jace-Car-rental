...
var Sliders = function() {
    ...
    if($('.slider:not(.inputSlider)').length) {

		$('.slider:not(.inputSlider)').each(function(){

			var sliderWrapper = $(this);
			var slider = sliderWrapper.find('.slider-init');
			var inputStart = $(this).closest('.control-field').find('input.slider-input-start');
			var inputEnd = $(this).closest('.control-field').find('input.slider-input-end');
	...
	if($('.slider.inputSlider').length) {

		$('.slider.inputSlider').each(function(){

			var sliderWrapper = $(this);
			var slider = sliderWrapper.find('.slider-init');
			var inputStart = $(sliderWrapper.data('inputmin'));
			var inputEnd = $(sliderWrapper.data('inputmax'));
			...
			inputStart.change(function() {
				$(this).closest('.inputSliderWrapper').find('.slider-init').slider( "values", 0,  $(this).val() );
			});
			
			inputEnd.change(function() {
				$(this).closest('.inputSliderWrapper').find('.slider-init').slider( "values", 1,  $(this).val() );
			});
...
var Tabs = function() {
	...
	if($('.tabs').length) {
		...
		$('.tabs .tabs-navigation li a').on('click', function(e) {

		    e.preventDefault();

		    var target = $(this).data('tab-target');

		    $('.tabs-content-tab.tabs-content-tab-active').removeClass('tabs-content-tab-active');
		    $('div[data-tab-id="' + target + '"]').addClass('tabs-content-tab-active');   
				
		    $('.tabs-navigation li.tabs-navigation-active').removeClass('tabs-navigation-active').addClass('tabs-navigation-link');
		    $(this).parent().addClass('tabs-navigation-active').removeClass('tabs-navigation-link');
...
var MobileNavigation = function() {
	...
	$('.navigation-header-trigger').on('click', function(e) {
...
$(window).load(function() {
    ...
    equalheight('.columns-equal-height > *'); 
